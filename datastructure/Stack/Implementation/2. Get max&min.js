...
/*
//  접근방법  //
    스택에 데이터가 추가될 때와 추출될 때 최대, 최소값이 어떻게 갱신되는지 구체화 해본다.
    1. 스택이 비어있을 경우 최대, 최소값은 동일하다.
    2. 스택에 데이터가 삽입될 경우 최소, 최대값과 비교하여 갱신할 수 있어야 한다.
    3. 스택에 데이터가 추출될 경우 최소, 최대값을 확인하고 갱신할 수 있어야 한다.

    핵심은 스택에서 최대, 최소값에 해당하는 데이터가 추출될 때 이전 최대, 최소값을 기억하고 있어야 한다는 것이다.
