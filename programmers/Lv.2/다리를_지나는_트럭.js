//  문제요약
//  1. bridge_length가 1~10,000, weight가 1~10,000, truck_weights는 배열이며 길이는 1~10,000 다.
//  2. bridge에는 bridge_length만큼의 truck이 올라올 수 있으며, 전체 무게가 weight보다 커선 안된다.
//  3. 1 <= truck =< weight 이면 정해진 truck_weights 순서대로 bridge를 건널 경우 걸리는 시간을 알아내라.
//  4. bridge_length = 2, weight = 10, truck_weights = [7,4,5,6], return 8
//  5. bridge_length = 100, weight = 100, truck_weights = [10], return 101
//  6. bridge_length = 100, weight = 100, truck_weights = [10,10,10,10,10,10,10,10,10,10], return 110
...
/*
    ...
    시간복잡도#1
    while문을 통해 배열 N을 2회 반복 O(2n)이므로 O(N), 초기에 0으로 배열을 채우지 않으면 시간복잡도를 더 줄일 수 있을 것 같다.
*/
